    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center px-4">
            <section className="w-full max-w-md">
                <form onSubmit={handleSubmit} className={styles.formConnexionDiv}>
                    {/* Titre */}
                    ...
                    <p>Pas encore de compte? <Link className={styles.elementSupprTitreLien}
                                                   href={baseUrl + "/inscription"}>Inscrivez-vous.</Link></p>
                </form>
            </section>
        </div>
    );
