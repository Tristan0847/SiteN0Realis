            ...
            <RatsConteneur>
                <div className="w-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div
                            className="relative w-full aspect-video rounded-lg overflow-hidden shadow-2xl border-2 border-red-600">
                            <iframe
        ...
        return (
            <RatsConteneur>
                <div className="w-full max-w-6xl flex flex-col items-center gap-8">
                    ...
                    <div
                        className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl border border-teal-500/30 hover:border-teal-400/60 transition-all duration-300">
                        <iframe
                            className="absolute inset-0 w-full h-full"
