            ...
            <section className="w-full max-w-md">
                <form onSubmit={gererSoumission} className={styles.formConnexionDiv}>
                    ...
                    {erreur && (
                        <div className={styles.messageFormDiv}>
                            <div className={styles.messageFormConteneur}>
                                <span className={styles.messageFormContenu}>{erreur}</span>
                            </div>
                        </div>
                    )}
                    ...
                    <div className={styles.formConnexionConteneurChamp}>
                        ...
                        <input id="nomUtilisateur" type="text" value={nomUtilisateur}
                               onChange={(e) => setNomUtilisateur(e.target.value)}
                               className={styles.formConnexionChamps} placeholder={votreNomPlaceholder} required/>
                    </div>
                    ...
                    <div className={styles.formConnexionConteneurChamp}>
                        ...
                        <input id="mdp1" type="password" value={mdp1} onChange={(e) => setMdp1(e.target.value)}
                               className={styles.formConnexionChamps} placeholder="**************" required/>
                    </div>
                    ...
                    <div className={styles.formConnexionConteneurChamp}>
                        ...
                        <input id="mdp2" type="password" value={mdp2} onChange={(e) => setMdp2(e.target.value)}
                               className={styles.formConnexionChamps} placeholder="**************" required/>
                    </div>

                    <div className={styles.formConnexionConteneurChamp + " italic"}>
                        <p className={styles.formConnexionLabel}>Le mot de passe doit avoir une longueur minimale de 12
                            caractères, contenir une majuscule, une minuscule, un chiffe et un caractère spécial.</p>
                    </div>
