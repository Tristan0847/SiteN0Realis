...
export default function HomePage() {
    return (
        <main style={{ padding: '2rem', fontFamily: 'Arial, sans-serif' }}>
            ...
            <ul>
                <li><strong>GET /api/dossiers</strong> : Récupérer les dossiers du projet</li>
                <li><strong>GET /api/blogs/[idDossier]</strong> : Récupérer les blogs d&apos;un dossier</li>
                <li><strong>GET /api/messages/[idDossier]/[idBlog]</strong> : Récupérer les messages d&apos;un blog dans un dossier</li>
            </ul>
