    ...
    return (
        <div style={{position: 'relative', minHeight: '100vh', background: "black"}}>
            ...
            <div style={{position: 'relative', zIndex: 1}}>
                <main
                    className="text-6xl font-extrabold text-black drop-shadow-md leading-tight min-h-screen flex flex-col justify-center items-center">
                    {afficherVideo ? (
                            <div
                                className="relative w-1/2 aspect-video rounded-lg overflow-hidden shadow-2xl border-2 border-gray-600">
                                <iframe
