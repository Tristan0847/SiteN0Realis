...
export default function RootLayout({children}: { children: React.ReactNode }) {
    return (
        <div className="min-h-screen relative" style={{background: "radial-gradient(circle," +
            ...
            <div className="relative min-h-screen font-mono z-10 mx-auto md:mx-3 grid grid-cols-1 gap-4 md:grid-cols-[clamp(14rem,21vw,22rem)_minmax(0,1fr)]">
                <AsideCommunity />
                <main className="min-w-0">
                    <div className="mx-4 md:mx-auto flex md:w-full max-w-7xl my-6 flex-col items-stretch gap-3">
                        {children}
                    </div>
                </main>
