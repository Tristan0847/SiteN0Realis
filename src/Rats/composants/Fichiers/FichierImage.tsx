 ...
 * Fichier image
 */
export class FichierImage extends FichierAbstract {
    ...
    public recupererContenuFichier() : JSX.Element {
        return(<img src={ this.src } alt={ this.nom } height={ this.height } width={ this.width }/>);
    }
}