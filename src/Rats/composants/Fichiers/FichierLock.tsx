...
import { FichierLockForm } from "./FichierLockForm";

/**
 * Fichier de formulaire débloquant un dossier
 */
export class FichierLock extends FichierAbstract {

    //#region Attributs/Propriétés
    private gestionnaireMdp : GestionnaireMotDePasse;
    private question : string;
    private callBackUnlock : (succes : boolean) => void;
     ...
     * @param cheminMdpsAcceptes Réponses acceptées
     */
    public constructor(id : number, nom: string, description: string|JSX.Element, estRouge: boolean, question : string, cheminMdpsAcceptes : string, callBackUnlock : (succes : boolean) => void) {
    ...
    public recupererContenuFichier() : JSX.Element {
        ...
        // Formulaire géré par un composant séparé
        return(<FichierLockForm question={ this.question } gestionnaireMdp={ this.gestionnaireMdp } callbackSucces={ (valeur : boolean) => this.callBackUnlock(valeur) } />);      
    }
